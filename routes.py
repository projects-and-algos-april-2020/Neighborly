...
from controller import index, add_user, login, logout, register, my_profile, dashboard, add_post, events, add_event, event_details, add_event_comments, update_event, delete_event, delete_post, add_like, post_details, update_post, neighbors_profile, add_post_comments, delete_user, upload_form, upload_file, all_users, update_aboutme
...
app.add_url_rule("/all_users", view_func=all_users)
app.add_url_rule("/my_profile", view_func=my_profile)
app.add_url_rule("/update_aboutme/<user_id>", view_func=update_aboutme, methods=['POST'])
app.add_url_rule("/upload_form", view_func=upload_form)
app.add_url_rule("/upload_file/<file>", view_func=upload_file, methods=['POST'])
#app.add_url_rule("/uploaded_file/<filename>", view_func=uploaded_file)
